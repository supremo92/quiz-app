...
function Playground() {
    ...
    const [currentQuestionText, setCurrentQuestionText] = useState<string>("Loading...")
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                console.log(err)
                // This could redirect to an error page, or even an error component.
            }
        }
        fetchData()
    }, [])

    // We have has to use mutliple useEffects because
    ...
    useEffect(() => {
        ...
        setCurrentQuestionText(decode(questions[currentQuestion].question))
